...
- Impressum: unbelegte zweite Registernummer entfernt, falsche DDG-Haftungsverweise durch den sachlichen Hinweis der anderen Marken ersetzt. HRB und Registergericht unverändert.
- Datenschutz: united-domains GmbH und aktuelle LfDI-Adresse; Ads-Cookies nach Google-Angaben erläutert.
...
- Typeform-Einbettung samt Loader und Datenschutzhinweis entfernt; Pilotanfrage jetzt über einen statischen E-Mail-Link, auch ohne JavaScript. Nur dessen Klick wird nach Analytics-Einwilligung gemessen; es wird kein erfolgreicher Versand und keine Ads-Conversion vorgetäuscht. Historisch bei Typeform gespeicherte Antworten und deren Löschung sind separat im Anbieter-Konto zu prüfen; das Entfernen der Website-Einbindung löscht keine Bestandsdaten.

## Prüfung

Die vorhandenen Browserprüfungen für Registrierung und Messung wurden auf den E-Mail-Einstieg umgestellt: kein externer Formulardienst, Kontaktlink auch ohne JavaScript, Klickmessung nur nach Analytics-Zustimmung, kein vorgetäuschtes Absenden. Ihr vollständiger Browserlauf erfolgt in der PR-CI; lokal wurden Syntax und die isolierten Einwilligungstests geprüft.
